...
### Elaborado por Mario Paulín como parte del proyecto agritech
### Este script realiza:
...
#    - Random Forest con variables de área (dummies)
...
# El modelo final se selecciona basado en el rendimiento en el conjunto de validación.
