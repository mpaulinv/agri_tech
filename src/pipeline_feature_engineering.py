### Pipeline para feature engineering.  Elaborado por Mario Paulín como parte del proyecto agritech  
...
from config import DATA_CLEAN_PATH, FEATURED_DATA_PATH, LOG_FEATURE_PATH, CONTINUOUS_COLUMNS
...
def setup_logger():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(LOG_FEATURE_PATH),
...
def main():
    setup_logger()
    cleaned_data = load_clean_data(DATA_CLEAN_PATH)
    ...
    save_featured_data(historicos, FEATURED_DATA_PATH)
